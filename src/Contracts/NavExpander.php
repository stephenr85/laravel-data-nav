 ...
 * an `instanceof InvocableNavItem` branch, so kinds were data-extensible but not
 * behavior-extensible.
 *
 * The default {@see InvocableNavExpander} preserves the original behavior: an
 * {@see InvocableNavItem} dispatches its named popcorn capability; any other
